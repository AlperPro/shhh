...
v3.DisableAllVisuals = function(_, v37)
    for _, v39 in ipairs(v37:GetDescendants()) do
        if v39:IsA("ParticleEmitter") or v39:IsA("Beam") or v39:IsA("Trail") or v39:IsA("PointLight") then
            v39.Enabled = false;
        end;
    end;
end;
v3.EnabledAllVisuals = function(_, v41)
    for _, v43 in pairs(v41:GetDescendants()) do
        if v43:IsA("ParticleEmitter") or v43:IsA("Beam") or v43:IsA("Trail") or v43:IsA("PointLight") then
            v43.Enabled = true;
        end;
    end;
end;
...
v3.UnixConnection2 = function(_, v69, v70, v71, v72)
    ...
    v3:AddTempFunction(function(v76)
        ...
        if v70 and (v71 and v71() or v71 == nil) and not v73 then
...
v3.UnixConnection = function(_, v80, v81, v82, v83)
    ...
    v85 = v84:Connect(function(v89)
        if not v88 then
            ...
            if v81 and (v82 and v82() or v82 == nil) and not v86 then
...
v3.UnixWithFrequency = function(_, v93, v94, v95, v96)
    ...
    v100 = v98:Connect(function(_)
        ...
        if v100 and os.clock() - v97 > v93 then
            v100:Disconnect();
            v100 = nil;
            if v96 then
                v96(1, v102);
