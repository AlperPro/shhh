...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		TweenService:Create(NotificationFrame, TweenInfo.new(0.8, Enum.EasingStyle.Quint), {backgroundtransparency = 0.5.6}):Play()
		wait(0.3)
